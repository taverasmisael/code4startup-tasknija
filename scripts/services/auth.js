...
function Auth ($firebaseAuth, $firebaseArray, $firebaseObject, FURL) {
	var ref = new Firebase(FURL), auth = $firebaseAuth(ref);
...
//External Function for MD5 Email encrytping, and returning a Gravatar URL
...
angular.module('TaskNinjaApp')
	.factory('Auth', ['$firebaseAuth', '$firebaseArray', '$firebaseObject', 'FURL', Auth]);
